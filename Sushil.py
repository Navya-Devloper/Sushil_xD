...
async def start_lovely():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await idk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await idk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await ydk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await ydk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await wdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await wdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await hdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await hdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await sdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await sdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await adk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await adk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await bdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await bdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await cdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await cdk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel=" @THUNDER_W0RLD"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @THUNDER_W0RLD"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await edk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await edk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await vkk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await kkk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await lkk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await lkk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await mkk(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await sid(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await shy(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await aan(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await ake(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await eel(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await khu(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            await khu(functions.channels.JoinChannelRequest(channel="@THUNDER_W0RLD"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
